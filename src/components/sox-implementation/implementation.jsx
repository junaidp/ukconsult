            ...
            <div className="col-lg-3 col-md-6 mb-3">
              <div className="approach-card pb-3 px-3 pt-4 h-100">
                <p>
                  ...
                  liaison, and post-implementation maintenance of internal
                  controls.
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 mb-3">
              <div className="approach-card pb-3 px-3 pt-4 h-100">
                <p>
                  ...
                  stakeholders to ensure materiality and accuracy.
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 mb-3">
            ...
            <div className="col-lg-3 col-md-6 mb-3">
              <div className="approach-card pb-3 px-3 pt-4 h-100">
                <p>
                  ...
                  mitigate risks and enhance process efficiency.
                </p>
              </div>
            </div>
            <div className="col-md-6 mb-3">
              <div className="approach-card pb-3 px-3 pt-4 h-100">
                <p>
                  ...
                  controls are fully owned by designated control owners.
                </p>
              </div>
            </div>
            <div className="col-md-6 mb-3">
